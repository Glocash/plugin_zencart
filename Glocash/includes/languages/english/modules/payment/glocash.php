<?php
  define('MODULE_PAYMENT_GLOCASH_TEXT_ADMIN_TITLE', 'GLOCASH Online Payment');
  define('MODULE_PAYMENT_GLOCASH_TEXT_CATALOG_TITLE', 'GLOCASH Online Payment');
  
  
  
  if( IS_ADMIN_FLAG === true ){
      define('MODULE_PAYMENT_GLOCASH_TEXT_DESCRIPTION', 
              '<strong>GLOCASH Online Payment</strong><br />'.
              'Click <a href="https://www.glocash.com/" target="_blank">here</a> to get your glocash account.'
              );
  } else {
      define('MODULE_PAYMENT_GLOCASH_TEXT_DESCRIPTION', '<strong>GLOCASH Online Payment</strong>');
  }
  ...
  define('MODULE_PAYMENT_GLOCASH_TEXT_CONFIG_2_1', 'GLOCASH E-Mail');  
